...
FRONT_LEFT   = Motor(index=0, id=0, name="Front Left")
FRONT_RIGHT  = Motor(index=0, id=1, name="Front Right") 
MIDDLE_LEFT  = Motor(index=1, id=2, name="Middle Left")
MIDDLE_RIGHT = Motor(index=2, id=3, name="Middle Right") 
BACK_LEFT    = Motor(index=1, id=4, name="Back Left")
BACK_RIGHT   = Motor(index=2, id=5, name="Back Right") 
